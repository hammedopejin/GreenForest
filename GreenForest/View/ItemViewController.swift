...
class ItemViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        if item != nil {
            ...
            priceLabel.text = item.price.convertToCurrency()
        ...
        if FUser.currentUser() != nil {
            ...
            downloadBasketFromFirestore(FUser.currentId()) { (basket) in
                ...
                if basket == nil {
                    ...
                    self.updateBasket(basket: basket!, withValues: [BasketKeys.kITEMIDS : basket!.itemIds])
                }
            }
    ...
    private func createNewBasket() {
        ...
        newBasket.ownerId = FUser.currentId()
